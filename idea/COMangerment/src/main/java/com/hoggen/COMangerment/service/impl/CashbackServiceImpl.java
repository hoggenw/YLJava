...
public class CashbackServiceImpl implements CashbackService {
    ...
    @Override
    public Map<String, Object> queryBackList(Cashback backCondition, int pageIndex, int pageSize ,Date endTime) {
        ...
        List<?> lists = cashbackDao.queryBackList(backCondition,rowIndex,pageSize,endTime);
        int count = cashbackDao.queryBackCount(backCondition,endTime);
