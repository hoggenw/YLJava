	...
	<div class="admin-content" id="app" v-cloak>
		<div class="admin-content-body am-u-lg-12">
			<div class="am-cf am-padding am-text-center">
				<strong class="am-text-primary am-text-lg am-text-success">周 期 一 级 预 警</strong>
			</div>
			<div class="am-g">
						...
						<table class="am-table am-table-striped am-text-nowrap am-table-hover">
							...
							<tbody>
								<tr v-for="item in gridData">
									...
									<td>{{item.restName}}</td>
									<td>{{item.oilBuy}}</td>
									<td>{{item.interValFlow}}</td>
									<td class="back-yellow">{{item.num}}</td>
								</tr>
							</tbody>
						</table>
...
<script type="text/javascript">
	seajs.use(['/backEnd/assets/js/pone']);
</script>
