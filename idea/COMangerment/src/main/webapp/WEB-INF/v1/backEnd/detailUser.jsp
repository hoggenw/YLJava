        ...
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg ">用户详情</strong></div>
			...
			<div class="am-g am-form">
				...
				<div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
					...
					<input type="text" placeholder="请输入推荐人手机号码" id="pMobile" v-model="search_info.pMobile" value="" disabled='disabled'>
				</div>
				...
				<div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
					...
					<select  v-model="search_info.birthdayType" id="birthdayType" disabled='disabled'>
